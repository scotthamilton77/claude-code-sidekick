...
*Critical Change from Legacy*: The legacy bash implementation calculated token counts by reading the entire transcript file on every render. In the Node.js architecture, this is moved to the **Supervisor**.
