 ...
 */
const PRBaselineDescriptor = sessionState('pr-baseline.json', PRBaselineStateSchema, null)
 ...
 */
const VCUnverifiedDescriptor = sessionState('vc-unverified.json', VCUnverifiedStateSchema, null)
