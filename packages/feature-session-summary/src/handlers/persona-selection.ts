 ...
 * @param weights - Optional map of persona ID to selection weight (default 1, non-positive = excluded)
 * @returns Selected persona, or null if pool is empty or all weights are non-positive
 */
