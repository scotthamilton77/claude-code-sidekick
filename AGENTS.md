...
- **OpenAI peer warning**: `openai@4.x` demands `zod@^3.23.8`, but the workspace standard is `zod@^4.1.13`; we accept the pnpm warning until we fully upgrade to OpenAI 6.x/Responses API.
