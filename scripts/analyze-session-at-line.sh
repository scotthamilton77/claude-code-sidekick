...
if [ "$USE_REVISED" = true ]; then
    ...
    if [ "$EXCERPT_TYPE" = "tiered" ]; then
        ...
        PROMPT_TEXT="${PROMPT_TEXT//\{SESSION_TITLE_MAX_LENGTH\}/${SUMMARY_TITLE_MAX_LENGTH:-50}}"
        PROMPT_TEXT="${PROMPT_TEXT//\{LATEST_INTENT_MAX_LENGTH\}/${SUMMARY_INTENT_MAX_LENGTH:-50}}"
