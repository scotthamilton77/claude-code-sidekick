...
2. **Check service logs**:
   - Find logs - your CLAUDE.md memories should already know where
   - Check for warnings and errors using grep
...
- If a type definition is missing, create it properly in the right location (SOLID principle applies)
